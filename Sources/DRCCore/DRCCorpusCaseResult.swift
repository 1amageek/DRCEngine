public struct DRCCorpusCaseResult: Sendable, Hashable, Codable {
    ...
    public let primaryProvenance: DRCCorpusCaseProvenance?
    public let oracleResult: DRCCorpusOracleResult?
    public let oracleComparison: DRCCorpusOracleComparison?
    ...
    public init(
        ...
        reportPath: String?,
        manifestPath: String?,
        primaryProvenance: DRCCorpusCaseProvenance? = nil,
        oracleResult: DRCCorpusOracleResult? = nil,
        oracleComparison: DRCCorpusOracleComparison? = nil
    ) {
        self.caseID = caseID
    ...
    public init(from decoder: Decoder) throws {
        ...
        primaryProvenance = try container.decodeIfPresent(DRCCorpusCaseProvenance.self, forKey: .primaryProvenance)
        oracleResult = try container.decodeIfPresent(DRCCorpusOracleResult.self, forKey: .oracleResult)
        oracleComparison = try container.decodeIfPresent(DRCCorpusOracleComparison.self, forKey: .oracleComparison)
    }
}
